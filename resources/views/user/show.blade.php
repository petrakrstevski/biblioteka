    ...
    <thead>
            ...
            <tr>
                ...
                <td>
                    <div class="media">
                        <div class="avatar me-2">
                            <img alt="avatar" src="https://upload.wikimedia.org/wikipedia/mk/b/bf/Beloto_cigance-kultura_thumb.jpg" class="rounded-circle" />
                        </div>
                        <div class="media-body align-self-center">
                            <h5 class="mb-0">Белото циганче</h5>
                            <p>роман за деца</p>
                        </div>
                    </div>
                </td>
            ...
            <tr>
                ...
                <td>
                    <div class="media">
                        <div class="avatar me-2">
                            <img alt="avatar" src="https://upload.wikimedia.org/wikipedia/commons/a/af/Begalka.jpg" class="rounded-circle" />
                        </div>
                        <div class="media-body align-self-center">
                            <h5 class="mb-0">Бегалка</h5>
                            <p>драма</p>
                        </div>
                    </div>
                </td>

...
<head>
    ...
    <title>Библиотека | CORK - Multipurpose Bootstrap Dashboard Template </title>
...
<body class=" layout-boxed">
        ...
        <header class="header navbar navbar-expand-sm expand-header">
            ...
            <ul class="navbar-item flex-row ms-lg-auto ms-0 action-area">
              ...
              <div class="dropdown-menu position-absolute" aria-labelledby="userProfileDropdown">
                ...
                @else
               <li class="nav-item">
                <a class="nav-link" href="{{ route('login') }}">Најави се</a>
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                     <li class="menu active">
                        <a href="#rd" data-bs-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                        ...
                        <ul class="collapse submenu list-unstyled show" id="dashboard" data-bs-parent="#accordionExample">
                            <li class="active">
                                <a href="{{route('book.list')}}"> Книги </a>
                            </li>
                            <li>
                                <a href="{{route('author.list')}}"> Автори </a>
                            </li>
                            <li>
                                <a href="{{route('user.list')}}"> Корисници </a>
                            </li>
                        </ul>
                    </li> 
                    ...
                    <li class="menu">
                        <a href="{{route('book.list')}}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        <a href="{{route('author.list')}}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                    ...
                    <!-- <li class="menu">
                        <a href="{{route('rent.user')}}" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                                <span>Изнајмени книги</span>
                            </div>
                        </a>
                    </li> -->
    ...
    <script src="https://.com/ajax/libs/jquery/3.6.4/jquery.min.js"></script>
